...
class MangaNewsPlatform(scraper: Scraper) : IPlatform(
    ...
    private fun getAgendaManga(checkedCountry: ICountry, calendar: Calendar): List<Manga>? {
        return try {
            val browser = Browser(Browser.BrowserType.CHROME, "https://www.manga-news.com/index.php/planning?p_year=${calendar.getYear()}&p_month=${calendar.getMonth()}")
